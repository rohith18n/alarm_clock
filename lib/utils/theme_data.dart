...
class GradientColors {
  ...
  static List<Color> sky = [const Color(0xFF6448FE), const Color(0xFF6448FE)];
  static List<Color> sunset = [
    const Color(0xFFFE6197),
    const Color(0xFFFE6197)
  ];
  static List<Color> sea = [const Color(0xFF61A3FE), const Color(0xFF61A3FE)];
  static List<Color> mango = [const Color(0xFFFFA738), const Color(0xFFFFA738)];
  static List<Color> fire = [const Color(0xFFFF5DCD), const Color(0xFFFF5DCD)];
}
